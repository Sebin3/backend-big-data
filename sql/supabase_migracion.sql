-- ============================================================
--  Big Data CRM - MIGRACIÓN PARA SUPABASE (copiar y pegar todo)
--  Ejecutar en SQL Editor de Supabase
-- ============================================================

-- 1) Columna de PERMISOS de módulo en users (jsonb)
...
-- CAMBIA el correo por el tuyo si no es este. ES IMPORTANTE: sin esto no
-- podrás usar los endpoints de administración (/api/users de gestión).
update public.users set role = 'superadmin'
where email = 'sebstianperezz9@gmail.com';
